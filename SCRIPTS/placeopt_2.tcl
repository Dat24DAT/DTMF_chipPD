...
### run prects opt
#opt_design -pre_cts -setup -report_prefix ${step}_opt2 -report_dir $report_dir

# report density 
check_floorplan -report_density 


### run placement and prects opt
#place_opt_design 
#time_design -pre_cts -report_prefix place -report_dir report
...
write_db -sdc $dbs_dir/place_opt2.dat
